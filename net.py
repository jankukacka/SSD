...
def Simple_SSD(num_classes=4):
    ...
    net['conv1'] = x = Conv2D(64, (3,3), padding='valid', activation='relu', name='conv1')(x)
    net['pool1'] = x = Conv2D(64, (2,2), padding='valid', strides=(2,2), name='pool1')(x)
    net['conv2'] = x = Conv2D(128, (3,3), padding='valid', activation='relu', name='conv2')(x)
    net['pool2'] = x = Conv2D(128, (2,2), padding='valid', strides=(2,2), name='pool2')(x)
    net['conv3'] = x = Conv2D(256, (3,3), padding='valid', activation='relu', name='conv3')(x)
    net['pool3'] = x = Conv2D(256, (2,2), padding='valid', strides=(2,2), name='pool3')(x)
    net['conv4_1'] = x = Conv2D(512, (3,3), padding='valid', activation='relu', name='conv4_1')(x)
    net['conv4_2'] = x = Conv2D(512, (3,3), padding='valid', activation='relu', name='conv4_2')(x)
    net['pool4'] = x = Conv2D(512, (2,2), padding='valid', strides=(2,2), name='pool4')(x)
    net['conv5_1'] = x = Conv2D(1024, (3,3), padding='valid', activation='relu', name='conv5_1')(x)
    net['conv5_2'] = x = Conv2D(1024, (3,3), padding='valid', activation='relu', name='conv5_2')(x)
    net['pool5'] = x = Conv2D(512, (2,2), padding='valid', strides=(2,2), name='pool5')(x)
    net['conv6_1'] = x = Conv2D(256, (3,3), padding='valid', activation='relu', name='conv6_1')(x)
    net['conv6_2'] = x = Conv2D(256, (3,3), padding='valid', activation='relu', name='conv6_2')(x)
    ...
    net['anchor_conv5_2'] = AnchorGeneratorLayer(feature_stride=16, offset=55,
                                                 aspect_ratios=[.5,1,2])(net['conv5_2'])
    ...
    net['anchor_conv6_2'] = AnchorGeneratorLayer(feature_stride=32, offset=119,
                                                 aspect_ratios=[.5,1,2])(net['conv6_2'])
